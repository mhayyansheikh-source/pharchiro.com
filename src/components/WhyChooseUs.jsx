  ...
  const features = [
    {
      ...
      desc: "We use the latest technology to diagnose and treat pain more effectively.",
      icon: (
    ...
    },
    {
      ...
      desc: "Every treatment plan is tailored to your unique body and health goals.",
      icon: (
    ...
    {
      title: "Local to League City",
      desc: "Proudly serving the League City community with highly-rated chiropractic care.",
      icon: (
    ...
    <section className="py-5" style={{ backgroundColor: '#32373c', color: '#fff' }}>
      <div className="container py-lg-5">
        <div className="text-center mb-5">
          ...
          >
            Why Choose Pharaoh Health & Rehab?
          </motion.h2>
          <motion.div 
          ...
          {features.map((feature, idx) => (
            <div className="col-md-4 text-center" key={idx}>
              ...
              >
                ...
                <p className="text-light opacity-75">{feature.desc}</p>
              </motion.div>
            </div>
          ))}
        </div>
